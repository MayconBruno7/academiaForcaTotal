...
-- Copiando estrutura para tabela academia_forca_total.produtos_servicos
CREATE TABLE IF NOT EXISTS `produtos_servicos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `descricao` text COLLATE utf8mb4_general_ci,
  `imagem` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo` enum('produto','servico') COLLATE utf8mb4_general_ci NOT NULL,
  `preco` decimal(10,2) NOT NULL,
  `unidade` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
