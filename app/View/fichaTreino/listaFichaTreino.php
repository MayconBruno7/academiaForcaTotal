...
<?php if (count($dados) > 0): ?>
    <div class="d-flex justify-content-around m-5">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover table-sm" id="tbListaFichaTreino">
                <thead>
                    <tr>
                        <th scope="col">Id</th>
                ...
                <tbody>
                    <?php foreach ($dados as $value): ?>
                        <tr>
                            ...
                            <td><?= formatarData($value['data_inicio']) ?></td>
                            <td><?= formatarData($value['validade']) ?></td>
