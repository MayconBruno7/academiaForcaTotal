...
<form method="POST" action="<?= $this->request->formAction() ?>">
    ...
    <div class="row m-2">
        ...
        <div class="mb-3 col-4">
            ...
            <select class="form-select" name="nivel" id="nivel" required aria-label="Selecione o nível do usuário">
                <option value="" <?= (setValor('nivel') === "" ? 'selected' : "") ?>>Selecione o nível</option>
        ...
        <div class="mb-3 col-4">
            ...
            <select class="form-select" name="statusRegistro" id="statusRegistro" required aria-label="Selecione o status">
                <option value="" <?= (setValor('statusRegistro') === "" ? 'selected' : "") ?>>Selecione o status</option>
                <option value="1" <?= (setValor('statusRegistro') === "1" ? 'selected' : "") ?>>Ativo</option>
                <option value="2" <?= (setValor('statusRegistro') === "2" ? 'selected' : "") ?>>Inativo</option>
                <option value="3" <?= (setValor('statusRegistro') === "3" ? 'selected' : "") ?>>Bloqueado</option>
            </select>
